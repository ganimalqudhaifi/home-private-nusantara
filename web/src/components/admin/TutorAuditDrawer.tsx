  ...
  return (
    ...
    >
      <div className="space-y-6">
        {/* Profile Card */}
        <div className="p-4 rounded-2xl bg-surface-container-low dark:bg-surface-container-high border border-border-whisper dark:border-outline-variant flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-primary dark:text-blue-300 font-semibold mt-0.5">
              {tutor.university}
            </p>
          </div>
        </div>
        ...
        {/* Status Banner */}
        <div className="p-3.5 rounded-xl border border-amber-200 dark:border-amber-900 bg-amber-50/60 dark:bg-amber-950/20 flex items-center justify-between text-xs">
          <div className="flex items-center gap-2">
        ...
        <div className="p-4 rounded-2xl border border-border-whisper dark:border-outline-variant space-y-2.5 text-xs">
          ...
          <div className="flex flex-wrap gap-1.5">
            {tutor.subjects.map((s) => (
              <span
                key={s}
                className="px-2.5 py-1 rounded-lg bg-surface-container-low dark:bg-surface-container-high text-primary dark:text-white font-semibold"
              >
                {s}
              </span>
            ))}
        ...
        <div className="p-4 rounded-2xl border border-border-whisper dark:border-outline-variant space-y-3 text-xs">
          <h4 className="font-bold text-text-muted uppercase tracking-wider">
            Dokumen Verifikasi yang Diunggah
          </h4>

          <div className="space-y-2">
            <div className="flex items-center justify-between p-2.5 rounded-xl bg-surface-container-low dark:bg-surface-container-high">
              <div className="flex items-center gap-2">
        ...
        <div className="pt-2 space-y-2.5">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="py-2.5 px-3 rounded-xl border border-red-200 text-red-600 dark:border-red-900 text-xs font-bold hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors flex items-center justify-center gap-1.5"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="py-2.5 px-3 rounded-xl bg-surface-container-low hover:bg-surface-container-high text-primary dark:text-white border border-border-whisper text-xs font-bold transition-colors flex items-center justify-center gap-1.5"
            >
