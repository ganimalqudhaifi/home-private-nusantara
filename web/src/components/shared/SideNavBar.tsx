    ...
    >
      ...
      <div className="mt-auto pt-4 border-t border-border-whisper space-y-1.5">
        ...
        <button
          ...
          className={`w-full flex items-center ${isCollapsed ? 'justify-center p-3' : 'gap-3 px-3.5 py-2.5'} rounded-xl font-body text-sm font-medium transition-all text-text-muted hover:text-[#DC2626] hover:bg-red-50 mt-2`}
        >
