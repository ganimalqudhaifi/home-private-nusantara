    ...
    >
      <div className="px-4 md:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-emerald-50 dark:bg-emerald-950/40 text-emerald-800 dark:text-emerald-300 px-3.5 py-1.5 rounded-full text-xs font-semibold mb-3 border border-emerald-200 dark:border-emerald-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {CURATION_STEPS.map((step) => {
            ...
            return (
              <div
                key={step.step}
                className="bg-white dark:bg-surface-container-lowest p-6 rounded-2xl border border-border-whisper dark:border-outline-variant shadow-xs flex flex-col justify-between hover:-translate-y-1 transition-transform"
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <span className="font-mono text-2xl font-bold text-primary-container dark:text-blue-400">
                      {step.step}
                    </span>
                    <div className="w-10 h-10 rounded-xl bg-blue-50 dark:bg-blue-950/40 text-primary-container dark:text-blue-300 flex items-center justify-center">
                      <Icon className="w-5 h-5" />
                    </div>
                  </div>
                  <h3 className="font-headline text-base font-bold text-primary dark:text-white mb-2">
                    {step.title}
                  </h3>
