  ...
  return (
    <Drawer
      ...
      title={
        <div className="flex items-center gap-2">
          ...
          <span className="px-2 py-0.5 rounded text-xs font-mono font-bold bg-blue-50 text-blue-900 dark:bg-blue-950/50 dark:text-blue-300">
            #{session.code}
          </span>
        </div>
      }
    >
      <div className="space-y-6">
        ...
        {/* Schedule & Time */}
        <div className="p-4 rounded-2xl border border-border-whisper dark:border-outline-variant space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            ...
            <div className="flex items-center gap-2 text-text-primary dark:text-gray-200 font-mono">
        ...
        <div className="p-4 rounded-2xl border border-border-whisper dark:border-outline-variant space-y-3">
          ...
          <div className="flex items-start gap-2.5 text-sm text-text-primary dark:text-gray-200">
        ...
        {session.notes && (
          <div className="p-4 rounded-2xl bg-amber-50/50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900 space-y-2">
            ...
            <p className="text-xs text-text-primary dark:text-gray-200 leading-relaxed italic">
