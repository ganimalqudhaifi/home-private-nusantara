...
`Halo Admin Home Private Nusantara, saya sudah memesan sesi belajar dengan kode booking #${bookingCode} untuk siswa ${studentName} bersama tutor ${tutorName}. Mohon konfirmasi jadwalnya.`
 ...
 {/* Success Icon */}
 <div className="w-16 h-16 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center mx-auto border-2 border-emerald-500 shadow-sm animate-in zoom-in-75">
 ...
 <h3 className="font-headline text-xl md:text-2xl font-bold text-primary mt-2">
 ...
 {/* Ticket Box */}
 <div className="p-4 rounded-2xl bg-surface-container-low border border-border-whisper text-left space-y-3">
 ...
 <span className="font-mono text-sm font-extrabold text-primary-container">
 #{bookingCode}
 </span>
 </div>
