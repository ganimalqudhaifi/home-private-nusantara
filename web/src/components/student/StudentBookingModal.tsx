  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="p-4 rounded-xl bg-surface-container-low dark:bg-surface-container-high border border-border-whisper dark:border-outline-variant flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-1 text-[10px] text-emerald-700 dark:text-emerald-400 font-semibold mt-0.5">
        ...
        <div className="grid grid-cols-2 gap-3 p-3.5 rounded-xl border border-border-whisper dark:border-outline-variant bg-white dark:bg-surface-container-lowest text-xs">
          <div className="flex items-center gap-2">
            <Calendar className="w-4 h-4 text-primary-container dark:text-blue-300" />
            <div>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <select
            ...
            className="w-full px-3 py-2.5 rounded-xl border border-border-whisper dark:border-outline-variant bg-surface-container-low dark:bg-surface-container-lowest text-xs font-semibold focus:border-primary-container focus:ring-2 focus:ring-primary-container/20 outline-none"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="px-3.5 py-2 rounded-xl border border-border-whisper dark:border-outline-variant bg-surface-container-lowest text-xs"
            />
          </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <textarea
            ...
            className="px-3.5 py-2 rounded-xl border border-border-whisper dark:border-outline-variant bg-surface-container-lowest text-xs resize-none"
          />
        </div>
        ...
        {/* CTA Buttons */}
        <div className="pt-3 border-t border-border-whisper dark:border-outline-variant flex items-center justify-end gap-3">
          <button
            type="button"
            onClick={onClose}
