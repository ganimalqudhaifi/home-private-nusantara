...
export function StudentDatePickerSidebar({
 ...
 return (
 <aside
 className={`bg-white border border-border-whisper rounded-2xl p-6 shadow-sm ${className}`}
 >
 <div className="flex justify-between items-center mb-6">
 <div className="flex items-center gap-2">
 <CalendarIcon className="w-4 h-4 text-primary-container" />
 ...
 {prevMonthDays.map((d) => (
 <div key={`prev-${d}`} className="p-2 text-gray-300">
 {d}
 </div>
 ))}
 ...
 : isAvailable
 ?'bg-emerald-50 text-emerald-800 ring-1 ring-emerald-300/40 font-semibold hover:bg-emerald-100'
 ...
 <div className="pt-4 border-t border-border-whisper space-y-2">
