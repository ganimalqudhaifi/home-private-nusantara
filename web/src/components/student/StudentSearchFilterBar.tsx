...
export function StudentSearchFilterBar({
 ...
 return (
 <div
 className={`bg-white rounded-2xl border border-border-whisper p-6 shadow-sm space-y-5 ${className}`}
 >
 <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
 {/* Segmented Control for Level */}
 <div className="flex p-1 bg-surface-container-high rounded-xl shrink-0">
 <button
 type="button"
 onClick={() => {
 onSelectLevel('SD');
 ...
 className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-border-whisper bg-surface-container-low text-sm focus:border-primary-container focus:ring-2 focus:ring-primary-container/20 outline-none"
 />
 </div>
 </div>
 ...
 isSelected
 ? selectedLevel ==='SD'
 ?'bg-blue-50 text-blue-900 ring-2 ring-blue-500 font-bold shadow-xs'
 :'bg-indigo-50 text-indigo-900 ring-2 ring-indigo-500 font-bold shadow-xs'
 :'bg-surface-container-low text-text-muted border border-border-whisper hover:border-primary-container'
 }`}
 >
 Kelas {g}
 </button>
