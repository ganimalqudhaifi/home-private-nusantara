      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          ...
          <textarea
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-border-whisper dark:border-outline-variant bg-surface-container-lowest text-text-primary dark:text-white text-sm focus:border-primary-container focus:ring-2 focus:ring-primary-container/20 outline-none resize-none"
          />
        </div>
      </div>
