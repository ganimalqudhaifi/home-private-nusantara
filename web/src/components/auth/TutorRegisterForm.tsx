  ...
  if (isSuccess) {
    return (
      <div className="text-center py-8 space-y-4">
        <div className="w-16 h-16 bg-amber-50 dark:bg-amber-950/40 text-amber-600 rounded-full flex items-center justify-center mx-auto">
  ...
  return (
    <form onSubmit={handleSubmit} className={`space-y-4 ${className}`}>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-border-whisper dark:border-outline-variant bg-surface-container-lowest text-text-primary dark:text-white text-sm focus:border-primary-container focus:ring-2 focus:ring-primary-container/20 outline-none"
            />
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <input
            ...
            className="w-full px-4 py-2.5 rounded-xl border border-border-whisper dark:border-outline-variant bg-surface-container-lowest text-text-primary dark:text-white text-sm focus:border-primary-container focus:ring-2 focus:ring-primary-container/20 outline-none"
          />
        </div>
      </div>
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${
                  isSelected
                    ...
                    : 'bg-white dark:bg-surface-container-low text-text-muted border border-border-whisper hover:border-primary-container'
                }`}
              >
                {sub}
              </button>
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <label className="border-2 border-dashed border-border-whisper dark:border-outline-variant hover:border-primary-container rounded-xl p-4 text-center cursor-pointer bg-surface-container-low dark:bg-surface-container-high transition-colors flex flex-col items-center justify-center gap-1.5">
          <Upload className="w-5 h-5 text-primary-container dark:text-blue-300" />
