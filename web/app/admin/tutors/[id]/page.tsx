...
export default async function AdminTutorDetailPage({ params }: AdminTutorDetailPageProps) {
 ...
 <Link href="/admin/tutors" className="hover:text-primary flex items-center gap-1">
 ...
 {/* Bio & Subjects */}
 <div className="bg-white rounded-2xl border border-border-whisper p-6 shadow-sm space-y-4">
