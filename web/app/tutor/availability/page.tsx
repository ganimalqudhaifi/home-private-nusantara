...
export default function TutorAvailabilityPage({
  ...
  return (
    <div className="bg-surface dark:bg-slate-950 text-text-primary dark:text-gray-100 min-h-screen flex flex-col pb-24">
      {/* Top Header */}
      <TopNavBar
      ...
      {/* Sticky Bottom Bar */}
      <div className="fixed bottom-0 left-0 w-full bg-white dark:bg-surface-container-low border-t border-border-whisper dark:border-outline-variant shadow-[0_-4px_12px_rgba(0,0,0,0.06)] z-40">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-4 flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="text-sm text-text-muted dark:text-gray-300 flex items-center gap-2">
            <Info className="w-4 h-4 text-primary-container dark:text-blue-300 shrink-0" />
            <span>
