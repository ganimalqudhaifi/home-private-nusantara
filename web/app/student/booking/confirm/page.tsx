...
`Halo Admin Home Private Nusantara, saya ingin konfirmasi booking #${bookingCode}.`
 ...
 <div className="bg-white rounded-2xl border border-border-whisper p-8 shadow-sm text-center space-y-6 w-full">
 <div className="w-16 h-16 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center mx-auto border-2 border-emerald-500 shadow-xs">
 ...
 Kode booking resmi: <strong className="font-mono text-sm text-primary-container">#{bookingCode}</strong>
 </p>
 </div>

 <div className="p-4 rounded-xl bg-surface-container-low border border-border-whisper text-left text-xs space-y-2">
 ...
 className="w-full bg-surface-container-low hover:bg-surface-container-high text-primary py-2.5 px-4 rounded-xl text-xs font-semibold border border-border-whisper transition-colors flex items-center justify-center gap-2"
 >
