...
export default async function StudentDashboardPage({
 ...
 <div>
 <h1 className="font-headline text-2xl md:text-3xl font-extrabold text-primary mb-2">
 Halo, Fajar Pratama & Ibu Ratna
 </h1>
 <div className="inline-flex items-center gap-2 bg-blue-50 text-blue-900 px-3 py-1 rounded-full text-xs font-bold border border-blue-200">
 ...
 <div className="bg-white border border-border-whisper rounded-2xl p-6 shadow-sm flex items-center gap-4 hover:-translate-y-0.5 transition-transform">
 <div className="w-12 h-12 rounded-xl bg-blue-50 text-primary-container flex items-center justify-center shrink-0">
