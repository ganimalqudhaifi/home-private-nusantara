...
export default function StudentSearchPage({
  ...
  return (
    <div className="bg-surface text-text-primary min-h-screen flex flex-col">
      {/* Top Header - Public Guest View */}
      <TopNavBar activeRoute="/student/search" role="guest" />
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-12 space-y-8">
        <div>
          ...
          <p className="text-sm text-text-muted mt-1">
            Pilih jenjang, kelas, dan tanggal untuk menemukan pengajar terverifikasi. Konsultasi langsung ke WhatsApp tanpa perlu login/daftar.
          </p>
        </div>
      ...
      {/* WhatsApp Consultation & Booking Modal */}
      <StudentBookingModal
        isOpen={isBookingModalOpen}
