...
export default async function HomePage({ searchParams }: HomePageProps) {
  ...
  return (
    <div className="bg-surface dark:bg-slate-950 text-text-primary dark:text-gray-100 min-h-screen flex flex-col selection:bg-red-100 selection:text-red-900">
      {/* Top Navigation */}
